...
//  def mostRetweetedItr(x: Tweet) = throw new NoSuchElementException("mostRetweetedItr.empty")
...
class NonEmpty(elem: Tweet, left: TweetSet, right: TweetSet) extends TweetSet {
  ...
  def mostRetweeted: Tweet = {
    def mostRetweets(a: Tweet, b: Tweet): Tweet =
      if(a.retweets > b.retweets) a else b

    if(left.isEmpty && right.isEmpty) elem
    else if(right.isEmpty) mostRetweets(elem, left.mostRetweeted)
    else if(left.isEmpty) mostRetweets(elem, right.mostRetweeted)
    else mostRetweets(left.mostRetweeted, mostRetweets(elem, right.mostRetweeted))
  }
